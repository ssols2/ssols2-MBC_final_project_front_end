            ...
            <div class="image-grid">
              <div class="image-box">
                ...
                <div class="image-wrapper">
                  <!-- 백엔드 사진이 있으면 보여주고, 없으면 방금 찍은 로컬 사진(plate_image_url) 보여주기 -->
                  <img v-if="vehicleInfo.vehicleImg" :src="`${backendUrl}${vehicleInfo.vehicleImg}`"
                    class="captured-img" />
                  <img v-else :src="vehicleInfo.plate_image_url || '/assets/default-plate.png'" class="captured-img" />
                </div>
              </div>
              <div class="image-box">
                <p class="img-label">{{ t.plateCrop }}</p>
                <div class="image-wrapper plate-wrapper">
                  <img v-if="vehicleInfo.licensePlateImg" :src="`${backendUrl}${vehicleInfo.licensePlateImg}`"
                    class="captured-img" />
                  <img v-else :src="vehicleInfo.plate_image_url || '/assets/default-plate.png'" class="captured-img" />
                </div>
              </div>
          ...
          <div class="info-card">
            ...
            <div class="image-grid">
              <div class="image-box">
                <p class="img-label">{{ t.vehicleOriginal }}</p>
                <div class="image-wrapper">
                  <img :src="vehicleInfo.plate_image_url || '/assets/default-plate.png'" class="captured-img" />
                </div>
              </div>
              <div class="image-box">
                <p class="img-label">{{ t.plateCrop }}</p>
...
const TRANSLATIONS = {
  ...
  BRA: {
    ...
    loadingTitle: 'Reconhecendo placa...', vehicleOriginal: 'Veiculo Original', plateCrop: 'Recorte da Placa (YOLO)',
    noImage: 'Sem imagem', loadingGuide: 'Por favor, aguarde',
  ...
  CHN: {
    ...
    loadingTitle: '车牌识别中...', vehicleOriginal: '车辆原图', plateCrop: '车牌裁剪 (YOLO)', noImage: '无图像', loadingGuide: '请稍候',
    resultTitle: '车辆确认与结算',
  ...
  EUR: {
    ...
    loadingTitle: 'Recognizing Plate...', vehicleOriginal: 'Vehicle Original',
    plateCrop: 'Plate Crop (YOLO)', noImage: 'No image', loadingGuide: 'Please wait',
  ...
  IND: {
    ...
    loadingTitle: 'नंबर प्लेट पहचानी जा रही है...', vehicleOriginal: 'वाहन मूल',
    plateCrop: 'नंबर प्लेट क्रॉप (YOLO)', noImage: 'कोई छवि नहीं', loadingGuide: 'कृपया प्रतीक्षा करें',
...
const handleFileUpload = async (event) => {
  ...
  try {
    ...
    vehicleInfo.value = {
      ...
      vehicleImg: data.vehicle_img || data.vehicleImg || '',
      licensePlateImg: data.license_plate_img || data.licensePlateImg || '',
